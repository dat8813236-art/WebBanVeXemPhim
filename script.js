...
const movies = {
  ...
  summary:"Câu chuyện của “Avatar: Dòng Chảy Của Nước” lấy bối cảnh 10 năm sau những sự kiện xảy ra ở phần đầu tiên. Phim kể câu chuyện về gia đình mới của Jake Sully (Sam Worthington thủ vai) cùng những rắc rối theo sau và bi kịch họ phải chịu đựng khi phe loài người xâm lược hành tinh Pandora.",
  ...
  summary:"Spider-Man: No Way Home (Người Nhện: Không Còn Nhà) bắt đầu khi danh tính bị bại lộ, Peter Parker đến nhờ Doctor Strange giúp sức. Tuy nhiên, với loại bùa phép nguy hiểm, các vũ trụ va vào nhau và xuất hiện Green Globin, Doctor Octopus và Electro.",
  ...
  summary:"Với nhân vật trung tâm là J. Robert Oppenheimer, nhà vật lý lý thuyết người đứng đầu phòng thí nghiệm Los Alamos, thời kỳ Thế chiến II. Ông đóng vai trò quan trọng trong Dự án Manhattan, tiên phong trong nhiệm vụ phát triển vũ khí hạt nhân, và được coi là một trong những “cha đẻ của bom nguyên tử”.",
  ...
  summary:"Yak và gia đình phải đối mặt với nỗi kinh hoàng mới khi “Yee” – cô em út – đột ngột mất tích bí ẩn. Yak buộc phải cùng Yos, Yod và Papan lên đường đến “Bong Sa Noh Bian” – khu rừng ma ám – để cứu Yee trước khi những linh hồn tà ác một lần nữa bị đánh thức.",
  ...
  summary:"Bộ phim đầu tiên trong bộ ba phim Thanh Gươm Diệt Quỷ: Vô Hạn Thành. Đây là phần bắt đầu cho trận chiến cuối cùng giữa Sát Quỷ Đoàn cùng Muzan và bè lũ quỷ tại Vô Hạn Thành. Bộ phim quy tụ gần như toàn bộ Trụ Cột & các nhân vật chính đối đầu nhóm Thượng Huyền mạnh nhất của Muzan; cùng bối cảnh Vô Hạn Thành phức tạp, kiến trúc đảo lộn và di chuyển liên tục hứa hẹn mang đến những trận chiến đấu đầy mãn nhãn.",
  ...
  summary:"Nhà Ma Xó xoay quanh câu chuyện về bà Hiền, người phụ nữ một mình nuôi 3 người con sau tai nạn chồng qua đời. Mọi chuyện bắt đầu khi người con trai giữa trong một lần thả lưới bắt cá vớt được một cái khạp bằng sành, nắp đậy kín. Từ đó, những hiện tượng kỳ quái liên tiếp xảy ra trong gia đình.",
  ...
  summary:"Sau một chuyến bay thám hiểm vũ trụ, bốn phi hành gia bất ngờ sở hữu năng lực siêu nhiên và trở thành gia đình siêu anh hùng đầu tiên của Marvel. The Fantastic Four: First Steps là bộ phim mở đầu Phase 6, đặt nền móng cho siêu bom tấn Avengers: Doomsday trong năm sau.",
  ...
  summary:"Bộ phim xoay quanh một sát thủ có tên là John Wick (do Keanu Reeves thủ vai), được thuê để giết chết chính người bạn chí cốt của mình. Bên cạnh đó, sự xuất hiện của một cô gái bí ẩn khiến phi vụ của anh gặp thêm nhiều rắc rối. Và rồi mọi chuyện sẽ đi đến đâu?",
  ...
  summary:"Những Kẻ Khờ Mộng Mơ là câu chuyện tình yêu tuyệt đẹp thời hiện đại giữa chàng nhạc công piano tài hoa chuyên diễn tại các quán bar Sebastian (Ryan Gosling) và cô diễn viên mới nổi xinh đẹp Mia Dolan (Emma Stone). Thế nhưng, ở thiên đường điện ảnh Hollywood, tình yêu và sự thành công dường như không thể song hành. Khi thành công và sự nổi tiếng đến, họ sẽ phải đối mặt ra sao?",
